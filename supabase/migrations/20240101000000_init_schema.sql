...
DROP TABLE IF EXISTS candidate_likes CASCADE;
DROP TABLE IF EXISTS candidate_activities CASCADE;
DROP TABLE IF EXISTS preparation_item_completions CASCADE;
DROP TABLE IF EXISTS preparation_items CASCADE;
